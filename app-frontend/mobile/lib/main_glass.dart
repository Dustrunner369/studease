  ...
  Widget _buildHeader() {
    return Row(
      ...
      children: [
        ...
        // line-art illustration: coffee, steam, sparkles
        const CustomPaint(
          size: Size(92, 76),
          painter: _CoffeeDoodlePainter(),
        ),
      ],
    );
  }
...
// ---------------------------------------------------------------------------
// Header illustration — coffee cup, steam, sparkles in the accent trio
// ---------------------------------------------------------------------------

class _CoffeeDoodlePainter extends CustomPainter {
  const _CoffeeDoodlePainter();
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final coral = stroke(Tone.coral);
    final teal = stroke(Tone.teal);
    final amber = stroke(Tone.amber);

    // cup body
    final cup = Path()
      ..moveTo(24, 38)
      ..lineTo(26, 52)
      ..quadraticBezierTo(27, 58, 34, 58)
      ..lineTo(48, 58)
      ..quadraticBezierTo(55, 58, 56, 52)
      ..lineTo(58, 38)
      ..close();
    canvas.drawPath(cup, coral);

    // handle
    canvas.drawArc(
      Rect.fromCircle(center: const Offset(60, 45), radius: 7),
      -math.pi / 2,
      math.pi,
      false,
      coral,
    ...
    // saucer
    canvas.drawLine(const Offset(18, 64), const Offset(64, 64), coral);

    // steam
    final steam1 = Path()
      ..moveTo(35, 30)
      ..cubicTo(31, 25, 39, 20, 35, 13);
    final steam2 = Path()
      ..moveTo(47, 30)
      ..cubicTo(43, 25, 51, 20, 47, 13);
    canvas.drawPath(steam1, teal);
    canvas.drawPath(steam2, teal);

    // sparkles
    void sparkle(Offset c, double r, Paint p) {
      canvas.drawLine(c - Offset(0, r), c + Offset(0, r), p);
      canvas.drawLine(c - Offset(r, 0), c + Offset(r, 0), p);
    }

    sparkle(const Offset(74, 18), 5, amber);
    sparkle(const Offset(14, 26), 4, amber);
    sparkle(const Offset(70, 52), 3.5, teal);
  }

  @override
  bool shouldRepaint(_CoffeeDoodlePainter old) => false;
}